...
def discover_db(connection):
    keys_to_remove = ['health_concerns', 'dashboard_metrics', 'addresses', 'insurance_benefit_tiers', 'secure_uploads', 'interaction_topics', 'ticket_comments', 'educations', 'users_roles', 'category_links', 'on_demand_tickets', 'deliverables', 'specialties', 'health_concerns_educations', 'plan_types', 'permissions', 'ticket_deliverables', 'ar_internal_metadata', 'schema_migrations', 'settings', 'appointments', 'mailboxer_receipts', 'care_pods', 'devices', 'organization_plans', 'ticket_types', 'feedbacks', 'users', 'specialty_links', 'tags', 'alerts', 'ticket_states', 'roadmap_entities', 'user_doctors', 'muted_activities', 'navigator_note_samples', 'versions', 'doctors', 'plans', 'risk_scores', 'bundles', 'user_care_pods', 'claims', 'employee_statuses', 'employees', 'announcements', 'interaction_modalities', 'saml_identifiers', 'third_party_admins', 'tickets', 'bundle_entities', 'mailboxer_participants', 'scores', 'doctor_links', 'mailboxer_notifications', 'roles', 'employee_plans', 'interactions', 'products', 'organization_health_concerns', 'spendings', 'procedures', 'care_gaps', 'invites', 'categories', 'tag_links', 'on_demand_ticket_messages', 'roadmaps', 'user_facilities', 'mailboxer_conversation_opt_outs', 'mailboxer_conversations', 'ticket_transitions', 'services', 'partner_cards', 'uploads', 'pg_search_documents', 'score_sources', 'activities', 'claim_categories', 'organizations', 'employee_care_gaps', 'facilities', 'roadmap_items', 'roadmaps_educations']
